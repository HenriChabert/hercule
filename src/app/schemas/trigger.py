...
def url_regex_field_factory(**kwargs: Any):
    return Field(description="The URL regex of the trigger", pattern=r"^https?://.*$", examples=[".*", "https://example.com", "https://example.com/.*"], **kwargs)
...
class TriggerBase(BaseModel):
    ...
    url_regex: Annotated[str, url_regex_field_factory(default=None)]
